...
describe("Staking Test", function () {
  ...
  describe("Staking", function () {
    ...
    // })
    // it("Prevents staking if closed", async function(){
    //   // Approve for staking
    //   await connectNFTAcc.setApprovalForAll(Staking.address, true);
    //   await connectNFTAcc.approve(Staking.address, 1);
    //   await NFT.isApprovedForAll(testAcc1.address, Staking.address);
    //   expectRevert(await connectStakingAcc.stakeToken(1), "Staking is not open yet");
    // })
  });
});
